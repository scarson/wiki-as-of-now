...
| 2 — Build governs filter (gated) | 🚧 In progress (branch `claude/wikiasofnow-detector-phase2-ZP1uQ`) | — | Task 2.1 (`39039e6`), Task 2.2 cross-clause, Task 2.3 noun-modifier, Task 2.4 named-entity shipped; remaining discriminator 2.5 (parenthetical/range) |
